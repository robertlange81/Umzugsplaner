...
public class TaskInitializer {
    ...
    public static void InitTasks(Date removalDate) {
        ...
        Task informAuthoritiesAndContractors = new Task("Ummeldung Behörden etc.", "Nach Ihrem Umzug (aber nicht davor!) müssen Sie sich in Ihrem Einwohnermeldeamt ummelden. Geben Sie auch Ihre neue Adresse an Ihre Vertragspartner weiter und verlasen Sie sich nicht auf den Nachsendeauftrag:" +
                "\n* Einwohnermeldeamt" +
        ...
        Task.addTask(informAuthoritiesAndContractors);
