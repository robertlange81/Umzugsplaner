...
import com.planner.generic.base.Helpers.Comparators.ComparatorSortable;
import com.planner.generic.base.Helpers.DBConverter.LinkMapConverter;
import com.planner.generic.base.Helpers.DBConverter.PriorityConverter;
import com.planner.generic.base.Helpers.DBConverter.TaskTypeConverter;
import com.planner.generic.base.Helpers.DBConverter.TimestampConverter;
import com.planner.generic.base.Helpers.DBConverter.UuidConverter;
...
public class Task implements Serializable {
    ...
    public com.planner.generic.base.Model.Priority priority; // 4
    ...
    public Task(UUID uuid, String name, String description) {
        ...
        date = null;
        priority = com.planner.generic.base.Model.Priority.Normal;
        costs = 0L;
        type = new TaskType(0);
        links = new TreeMap<>();
        createdAt = new Date();
