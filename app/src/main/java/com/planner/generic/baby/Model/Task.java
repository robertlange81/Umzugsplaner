...
import com.planner.generic.baby.Helpers.Comparators.ComparatorSortable;
import com.planner.generic.baby.Helpers.DBConverter.LinkMapConverter;
import com.planner.generic.baby.Helpers.DBConverter.PriorityConverter;
import com.planner.generic.baby.Helpers.DBConverter.TaskTypeConverter;
import com.planner.generic.baby.Helpers.DBConverter.TimestampConverter;
...
public class Task implements Serializable {
    ...
    public com.planner.generic.baby.Model.Priority priority; // 4
    ...
    public Task(UUID uuid, String name, String description) {
        ...
        date = null;
        priority = com.planner.generic.baby.Model.Priority.Normal;
        costs = 0L;
        type = new TaskType(0);
        links = new TreeMap<>();
        createdAt = new Date();
